...
graph TB
  ...
  Langfuse["<img src='/langfuse_logo.svg' width='60' height='60' alt='Langfuse Logo' style='margin-bottom: 15px; ' class='show-light' /><img src='/langfuse_logo_dark.svg' width='60' height='60' alt='Langfuse Logo' style='margin-bottom: 15px; ' class='show-dark' />Tracing/Observability<br/>Evaluation<br/>Prompt Management<br/>Cost Tracking<br/>Security Monitoring<br/>Experiments<br/>Playground<br/>... (see docs)"]
...
> "Generative AI technology evolves at an unprecedented rate. LiteLLM is an amazing product that helps our Engineering teams quickly prototype, launch, and deliver new AI features at scale. Langfuse instrumentation gives our teams the visibility to quickly pinpoint issues across our LLMops stack and resolve them in minutes. Together, these products are essential at Fletch and consistently deliver best-in-class experiences for our customers."
>
> — Darien Kindlund, VP of Technology at Fletch

> "Using LiteLLM with Langfuse has significantly improved our ability to easily monitor our LLM usage across all of our applications at ai.moda. It's like Sentry, but for AI!"
>
> — David Manouchehri, Director at ai.moda
